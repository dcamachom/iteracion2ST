...
public class SQLInmueble {
	...
	public long adicionarInmueble(PersistenceManager pm, long id,int costoBase, long idOperador) {
		Query q = pm.newQuery(SQL, "INSERT INTO " + pa.darTablaInmueble () + "(id, costoBase, idOperador) values (?, ?, ?)");
        q.setParameters(id, costoBase, idOperador);
